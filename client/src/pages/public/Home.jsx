...
export default function Home() {
  ...
  return (
    <div className="space-y-20 pb-20">
      {/* Hero Section */}
      <section className="relative overflow-hidden pt-12 pb-20 lg:pt-20 lg:pb-28 bg-gradient-to-b from-brand-50/70 via-white to-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            {/* Left Content */}
            <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-brand-100/80 border border-brand-200 text-brand-800 text-xs font-semibold shadow-sm">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3.5 pt-2">
                ...
                <Link
                  to="/become-worker"
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-xl bg-white hover:bg-slate-50 text-slate-800 font-bold text-sm border border-slate-300 shadow-sm transition-all"
                >
                  <Wrench className="w-4 h-4 text-saffron-600" />
            ...
            <div className="lg:col-span-5 relative">
              <div className="relative mx-auto max-w-md bg-white rounded-3xl p-6 shadow-2xl border border-slate-100 space-y-5">
                <div className="flex items-center justify-between border-b border-slate-100 pb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-slate-500">Deep Cleaning Specialist • 4.9★</div>
                    </div>
                  </div>
                ...
                <div className="bg-slate-50 rounded-2xl p-4 border border-slate-100 space-y-2.5 text-xs">
                  <div className="flex justify-between text-slate-600">
                    <span>Service:</span>
                    <strong className="text-slate-900">3 BHK Deep Cleaning</strong>
                  </div>
                  <div className="flex justify-between text-slate-600">
                    <span>Assigned Via:</span>
                    <span className="text-brand-700 font-semibold">Automatic Fairness Engine</span>
                  </div>
                  <div className="flex justify-between text-slate-600">
                    <span>Platform Commission:</span>
                    <strong className="text-emerald-700">₹0 on Small Jobs (Protected)</strong>
                  </div>
                  <div className="flex justify-between text-slate-600 border-t border-slate-200 pt-2 text-sm font-bold text-slate-900">
                    <span>Payable After Work:</span>
                    <span className="text-brand-600">₹1,999</span>
                  </div>
                </div>

                <div className="flex items-center justify-between text-[11px] text-slate-500">
                  <span>📍 HSR Layout, Bengaluru (1.2 km away)</span>
                  <span className="font-semibold text-brand-600">ETA: 15 Mins</span>
                </div>

                <Link
                  to="/services"
                  className="w-full block text-center py-2.5 rounded-xl bg-slate-900 hover:bg-slate-800 text-white font-semibold text-xs transition-colors shadow-md"
                >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.slice(0, 6).map((service) => (
            <div
              key={service.id}
              className="bg-white rounded-2xl overflow-hidden border border-slate-200/90 hover:border-brand-300 hover:shadow-xl transition-all group flex flex-col justify-between"
            >
              <div>
              ...
              <div className="p-5 pt-0">
                <div className="flex items-center justify-between border-t border-slate-100 pt-3">
                  <div>
                    <span className="text-[10px] text-slate-500 uppercase font-semibold block">Pricing</span>
        ...
        <div className="text-center mt-10">
          <Link
            to="/services"
            className="inline-flex items-center gap-2 text-sm font-bold text-brand-700 hover:text-brand-800 bg-brand-50 hover:bg-brand-100 border border-brand-200 px-6 py-3 rounded-xl transition-colors"
          >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              ...
              <div key={s.step} className="bg-slate-800/80 p-6 rounded-2xl border border-slate-700 relative group hover:border-brand-500 transition-colors">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          {/* Worker Benefits */}
          <div className="bg-amber-50/70 border border-amber-200/80 rounded-3xl p-8 space-y-6">
            <div className="inline-flex items-center gap-2 bg-amber-200/60 text-amber-900 font-bold px-3 py-1 rounded-full text-xs">
              <Wrench className="w-3.5 h-3.5 text-amber-700" /> For Service Providers
            </div>
            <h3 className="text-2xl font-bold font-display text-slate-900">Why Workers Choose Sahaayak</h3>
          ...
          <div className="bg-teal-50/70 border border-teal-200/80 rounded-3xl p-8 space-y-6">
            <div className="inline-flex items-center gap-2 bg-teal-200/60 text-teal-900 font-bold px-3 py-1 rounded-full text-xs">
              <ShieldCheck className="w-3.5 h-3.5 text-teal-700" /> For Customers
            </div>
            <h3 className="text-2xl font-bold font-display text-slate-900">Why Customers Trust Sahaayak</h3>
            <ul className="space-y-3.5 text-sm text-slate-700">
              {[
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-10 space-y-2">
          ...
          <p className="text-sm text-slate-600">Everything you need to know about our service standards and guarantees.</p>
        </div>
