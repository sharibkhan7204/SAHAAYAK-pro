...
import {
  ...
  ShieldCheck, TrendingUp, Sparkles, ArrowUpRight, BarChart2, Package, LogOut
} from 'lucide-react';
      ...
      <div className="flex items-center justify-between flex-wrap gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="px-4 py-2 rounded-xl bg-rose-50 hover:bg-rose-100 border border-rose-200 text-rose-700 font-bold transition-colors shadow-xs flex items-center gap-1.5 cursor-pointer"
